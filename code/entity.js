class Entidad {
  ...
  borrar() {
    ...
    if (this instanceof Enemy) {
      this.juego.enemigosO = this.juego.enemigosO.filter((k) => k != this);
    } else if (this instanceof Ally) {
      this.juego.entidades = this.juego.entidades.filter((k) => k != this);
    } else if (this instanceof Enemy) {
      this.juego.enemigosP = this.juego.enemigosP.filter((k) => k != this);
    } else if (this instanceof Enemy) {
      this.juego.enemigosG = this.juego.enemigosG.filter((k) => k != this);
    }
  ...
  actualizarPosicionEnGrid() { 
    this.grid.update(this.container);
  }
  ...
  //   if(objetivo.miCeldaActual() == this.miCeldaActual){
  //     this.vida -= this.damage
  //   }
  // }
